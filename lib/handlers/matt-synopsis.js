...
//
// Model: Opus 4.7 (best Claude for synthesis-style coaching insight). About
// $0.15 per generation against the workspace API key. Override with the
// MATT_MODEL env var to A/B against Sonnet or Haiku without redeploying code.
...
\`\`\``;
    ...
    const resp = await anthropic.messages.create({
      model: process.env.MATT_MODEL || 'claude-opus-4-7',  // best for synthesis insight
      max_tokens: 1000,
